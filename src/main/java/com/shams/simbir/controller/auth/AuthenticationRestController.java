...
import com.shams.simbir.service.security.JwtTokenProvider;
...
public class AuthenticationRestController {
    ...
    public ResponseEntity<?> authenticate(@RequestBody AuthenticationRequestDTO request){
        try {
            ...
            User user = userRepository.findByLogin(request.getLogin()).orElseThrow(() -> new UsernameNotFoundException("User doesn't exist"));
